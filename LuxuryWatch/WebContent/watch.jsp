			...
			<div class="single-main">
				...
				<div class="sngl-top">
						...
						<div class="flexslider">
							  <ul class="slides">
								<li data-thumb="images/s-1.jpg">
									<div class="thumb-image"> <img id="item_image" src=${requestScope.databean.source} data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
					...
					<div class="col-md-7 single-top-right">
						...
						<h2 >${requestScope.databean.name}</h2>
							<div class="star-on">
							...
							<h5 id="item_price" class="item_price">${requestScope.databean.price}</h5>
							...
							<input type="hidden" name="item_name" value=${requestScope.databean.name}>
							<input type="hidden" name="item_price" value=${requestScope.databean.price}>
							<input type="hidden" name="item_source" value=${requestScope.databean.source}>
							<input type="submit" value="Add To Cart" class="add-cart item_add"/>
							
								<!--  <a id="add_cart_button" href="products.html" class="add-cart item_add">ADD TO CART</a> -->
									</form>
								<script src="js/simpleCart.min.js"> </script>
