			...
			<div class="top-header-main">
				...
				<div class="col-md-6 top-header-left">
					<div class="cart box_1">
						<a href="checkout.jsp"> <c:out
								value="${sessionScope.userBean.email}"></c:out>
							<div class="total">
						...
						<p>
							<a href="javascript:;" class="simpleCart_empty"
								style="float: right;">Empty Cart</a>
						</p>
						<div class="clearfix"></div>
					</div>
				</div>
				...
				<div class="cart-items">
					...
					<div class="in-check">
						...
						<ul class="cart-header">
							...
							<li class="ring-in"><a href="Rolex.html"><img
									id="item1_image" src=${requestScope.cartBean.source
									} class="img-responsive" alt=""></a></li>
							<li><span id="item1_name" class="name">${requestScope.cartBean.name}</span></li>
							<li><span id="item1_price" class="cost"> $ ${requestScope.cartBean.price}</span></li>
							<li><span>Free</span>
						...
						<!-- 									src="images/c-1.jpg" class="img-responsive" alt=""></a></li> -->
						...
						<!-- 							<li class="ring-in"><a href="single.html"><img -->
						<!-- 									src="images/c-2.jpg" class="img-responsive" alt=""></a></li> -->
						<!-- 							<li><span class="name">Analog Watches</span></li> -->
						...
						<!-- 							<li class="ring-in"><a href="single.html"><img -->
						<!-- 									src="images/c-3.jpg" class="img-responsive" alt=""></a></li> -->
						<!-- 							<li><span class="name">Analog Watches</span></li> -->
						...
						<!-- 					</div> -->
						<br> <br>
						<div class=" account-right account-left"
							style="width: 100px; height: 100px; float: right; clear: left">
			...
			<div class="container">
				<div class="footer-top">
					...
					<div class="col-md-6 footer-right">
						<p>
							© 2015 Luxury Watches. All Rights Reserved | Design by <a
